...
then
    envsubst \
    '${VAGRANT_BOX},${PRIVILEGED},${INTERACTIVE},${MEMORY},${CPU},${DISK_SIZE},${GITHUB_RUNNER_FILE},${GITLAB_RUNNER_FILE},${RUNNER_NAME},${RANDOM_STR},${RUNNERS},${GITHUB_RUNNER_LABELS},${GITLAB_RUNNER_TAGS},${GITHUB_RUNNER_URL},${GITLAB_RUNNER_URL},${PAT},${TOKEN},${REGISTRATION_TOKEN}' \
